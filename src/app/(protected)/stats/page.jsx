    ...
    <div className='w-full'>
      <div className='max-w-[800px] mx-auto pt-10'>
        ...
        <div className='w-full grid grid-cols-3 gap-4  h-30 '>
          <div className='bg-white p-4 border border-gray-300 rounded transition-all ease-in-out duration-200 hover:shadow-xl'>
        ...
        <div className='w-full  h-100 grid grid-cols-2 gap-4 mt-10'>
            ...
            <div className='w-full   h-full mt-4 '>
              <div className='w-full gap-3 h-fit border-b pb-4 border-gray-300  flex  rounded mt-2'>
                <div className=' overflow-hidden'>
                  <Image src={'/placeholder.png'} width={100} height={100} alt='title' className='rounded-sm' />
                </div>
              ...
              <div className='w-full h-fit pt-4 '>
                ...
                <div className="flex items-center justify-between gap-2 mt-4">
                  <button className='bg-gray-100 border-gray-300 border transition-all ease-in-out duration-200 w-fit mt-4 cursor-pointer active:scale-90 flex items-center gap-2 text-black text-sm px-6 rounded py-2'>
          ...
          <div className='w-full  border border-gray-300 p-4 rounded'>
